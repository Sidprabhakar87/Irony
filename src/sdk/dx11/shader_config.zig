...
pub const ShaderConfig = struct {
    ...
    pub fn getNativeDepthStencil(self: *const ShaderConfig) w32.D3D11_DEPTH_STENCIL_DESC {
        var result: w32.D3D11_DEPTH_STENCIL_DESC = undefined;
    ...
    pub const Depth = struct {
        ...
        pub fn toNative(self: *const Depth, out: *w32.D3D11_DEPTH_STENCIL_DESC) void {
    ...
    pub const Stencil = struct {
        ...
        pub fn toNative(self: *const Stencil, out: *w32.D3D11_DEPTH_STENCIL_DESC) void {
            out.StencilEnable = 1;
        ...
        pub fn optionalToNative(self_maybe: *const ?Stencil, out: *w32.D3D11_DEPTH_STENCIL_DESC) void {
            if (self_maybe.*) |*self| {
                self.toNative(out);
                out.StencilEnable = 1;
            } else {
        ...
        pub const Face = struct {
            ...
            pub fn toNative(self: *const Face) w32.D3D11_DEPTH_STENCILOP_DESC {
                return .{
        ...
        pub const Operation = enum {
            ...
            pub fn toNative(self: Operation) w32.D3D11_STENCIL_OP {
                return switch (self) {
                    .keep => .KEEP,
                    .zero => .ZERO,
                    .replace => .REPLACE,
    ...
    pub const Blend = struct {
        ...
        pub fn toNative(self: *const Blend) w32.D3D11_BLEND_DESC {
            return .{
                ...
                .RenderTarget = switch (self.mode) {
                    .shared => |*target| [1]w32.D3D11_RENDER_TARGET_BLEND_DESC{Target.optionalToNative(target)} ** 8,
                    .independent => |*targets| block: {
                        var result: [8]w32.D3D11_RENDER_TARGET_BLEND_DESC = undefined;
        ...
        pub const Target = struct {
            ...
            pub fn toNative(self: *const Target) w32.D3D11_RENDER_TARGET_BLEND_DESC {
                return .{
                    .BlendEnable = 1,
            ...
            pub fn optionalToNative(maybe_self: *const ?Target) w32.D3D11_RENDER_TARGET_BLEND_DESC {
                if (maybe_self.*) |*self| {
        ...
        pub const Factor = enum {
            ...
            pub fn toNative(self: Factor) w32.D3D11_BLEND {
                return switch (self) {
                    .zero => .ZERO,
                    .one => .ONE,
                    .src_color => .SRC_COLOR,
        ...
        pub const Operation = enum {
            ...
            pub fn toNative(self: Operation) w32.D3D11_BLEND_OP {
                return switch (self) {
                    .add => .ADD,
                    .subtract => .SUBTRACT,
    ...
    pub const Rasterizer = struct {
        ...
        pub fn toNative(self: Rasterizer) w32.D3D11_RASTERIZER_DESC {
            return .{
        ...
        pub const FillMode = enum {
            ...
            pub fn toNative(self: FillMode) w32.D3D11_FILL_MODE {
                return switch (self) {
                    .wireframe => .WIREFRAME,
                    .solid => .SOLID,
                };
        ...
        pub const CullMode = enum {
            ...
            pub fn toNative(self: CullMode) w32.D3D11_CULL_MODE {
                return switch (self) {
                    .none => .NONE,
                    .front => .FRONT,
                    .back => .BACK,
    ...
    pub const ComparisonFunction = enum {
        ...
        pub fn toNative(self: ComparisonFunction) w32.D3D11_COMPARISON_FUNC {
            return switch (self) {
                .never => .NEVER,
                .less => .LESS,
                .equal => .EQUAL,
