...
pub fn Player(comptime game_id: build_info.Game) type {
    ...
    return switch (game_id) {
        ...
        .t8 => sdk.memory.StructWithOffsets(null, &.{
            ...
            field(0x2480, "used_heat", Bool, &.false),
            field(0x24A1, "in_heat", Bool, &.false),
            field(0x24E8, "stage_set_number", u32, &0),
            field(0x27EC, "input_side", PlayerSide, &.left),
            field(0x2814, "input", Input(.t8), &.{}),
            field(0x2880, "hit_lines", HitLines(.t8), &getDefaultHitLines(.t8)),
            field(0x2C80, "hurt_cylinders", HurtCylinders(.t8), &.{}),
            field(0x30C0, "collision_spheres", CollisionSpheres, &.{}),
            field(0x3848, "health", HealthValue, &.fromRaw(.{})),
            field(0x3858, "health_recover_limit", HealthValue, &.fromRaw(.{})),
